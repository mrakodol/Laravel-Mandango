 ...
 */
abstract class Category extends \Mandango\Document\Document implements \ArrayAccess
{
    /**
  ...
  'us' => 'Model\\User',
     ...
     *
     * @return \Mandango\Query The "articles" relation many-many.
     */
    public function getArticles()
    {
        return $this->getMandango()->getRepository('Model\Article')->createQuery(array('categories' => $this->getId()));
    }
