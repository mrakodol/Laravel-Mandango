 ...
 */
abstract class IdGeneratorSingleInheritanceParentRepository extends \Mandango\Repository
{
    ...
    {
        return $this->getMandango()->getRepository('Model\IdGeneratorSingleInheritanceGrandParent');
    }
