...
/**
 * Base class of repository of Model\Hierarchy document.
 */
abstract class HierarchyRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Model\Hierarchy';
        $this->isFile = false;
        $this->collectionName = 'hierarchies';
