 ...
 */
abstract class IdGeneratorSingleInheritanceChildRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->getMandango()->getRepository('Model\IdGeneratorSingleInheritanceParent');
    }
