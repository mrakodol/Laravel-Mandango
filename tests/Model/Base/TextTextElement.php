 ...
 */
abstract class TextTextElement extends \Model\TextElement implements \ArrayAccess
{
    /**
    ...
    public function setDocumentData($data, $clean = false)
    {
        ...
        } elseif (isset($data['_fields']['text_text'])) {
    ...
    public function setText_text($value)
    {
        if (!isset($this->data['fields']['text_text'])) {
            if (!$this->isNew()) {
                $this->getText_text();
                if ($value === $this->data['fields']['text_text']) {
                    return $this;
                }
            } else {
                if (null === $value) {
        ...
        } elseif ($value === $this->data['fields']['text_text']) {
            return $this;
        }
        ...
        } elseif ($value === $this->fieldsModified['text_text']) {
    ...
    public function getText_text()
    {
        if (!isset($this->data['fields']['text_text'])) {
            if ($this->isNew()) {
                $this->data['fields']['text_text'] = null;
            } elseif (!isset($this->data['fields']) || !array_key_exists('text_text', $this->data['fields'])) {
                $this->addFieldCache('text_text');
                $data = $this->getRepository()->getCollection()->findOne(array('_id' => $this->getId()), array('text_text' => 1));
                if (isset($data['text_text'])) {
                    $this->data['fields']['text_text'] = (string) $data['text_text'];
                } else {
                    $this->data['fields']['text_text'] = null;
