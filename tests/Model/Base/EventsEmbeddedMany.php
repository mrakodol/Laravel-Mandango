 ...
 */
abstract class EventsEmbeddedMany extends \Mandango\Document\Document implements \ArrayAccess
{
    /**
    ...
    public function setDocumentData($data, $clean = false)
    {
        ...
        if (isset($data['embedded'])) {
            $embedded = new \Mandango\Group\EmbeddedGroup('Model\EmbeddedEvents');
     ...
     *
     * @return \Mandango\Group\EmbeddedGroup The "embedded" embedded many.
     */
    public function getEmbedded()
    {
        if (!isset($this->data['embeddedsMany']['embedded'])) {
            $this->data['embeddedsMany']['embedded'] = $embedded = new \Mandango\Group\EmbeddedGroup('Model\EmbeddedEvents');
            $embedded->setRootAndPath($this, 'embedded');
        }
    ...
    public function fromArray(array $array)
    {
        ...
        if (isset($array['embedded'])) {
            ...
            foreach ($array['embedded'] as $documentData) {
                $embeddeds[] = $embedded = new \Model\EmbeddedEvents($this->getMandango());
