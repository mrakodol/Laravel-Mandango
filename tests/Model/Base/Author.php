 ...
 */
abstract class Author extends \Mandango\Document\Document implements \ArrayAccess
{
    /**
  ...
  'us' => 'Model\\User',
     ...
     *
     * @return \Mandango\Query The "articles" relation many-one.
     */
    public function getArticles()
    {
        return $this->getMandango()->getRepository('Model\Article')->createQuery(array('author' => $this->getId()));
    }
