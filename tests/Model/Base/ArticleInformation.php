 ...
 */
abstract class ArticleInformation extends \Mandango\Document\Document implements \ArrayAccess
{
    /**
    ...
    {
        return $this->getMandango()->getRepository('Model\Article')->createQuery(array('information' => $this->getId()))->one();
    }
