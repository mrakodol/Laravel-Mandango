    ...
    public function getModelArticleClass()
    {
        return array(
            ...
            'fields' => array(
                ...
                'likeUnset_reference_field' => array(
                    'type' => 'raw',
                    'dbName' => 'likeUnset',
                    'referenceField' => true,
                ),
                ...
                'friendUnset_reference_field' => array(
                    'type' => 'raw',
                    'dbName' => 'friendUnset',
                    'referenceField' => true,
                ),
            ...
            'referencesOne' => array(
                ...
                'like' => array(
                    ...
                    'field' => 'likeRef',
                    'onDelete' => 'cascade',
                    'discriminatorField' => '_mandangoDocumentClass',
                ...
                'likeUnset' => array(
                    ...
                    'discriminatorField' => '_mandangoDocumentClass',
                    'discriminatorMap' => false,
                    'field' => 'likeUnset_reference_field',
                ),
                'friend' => array(
                    'polymorphic' => true,
                    'field' => 'friendRef',
                ...
                'friendUnset' => array(
                    ...
                    'field' => 'friendUnset_reference_field',
                ),
            ),
